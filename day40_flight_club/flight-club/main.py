...
# Приветствуем и берем инфу от юзера
print("Welcome to the Flight Club, buddy.\nВозможно когда-нибудь это станет коммерческим проектом"
      "\nШучу. Такая херня никому не нужна.")
name = input("Ваше имя? > ")
lname = input('Ваша фамилия? > ')
email = input('Ваш имейл? > ')
# Используем функцию из data_manager
print(name, lname, email, sep='\n')
data_manager.add_user(user_name=name, user_lname=lname, user_email=email)
